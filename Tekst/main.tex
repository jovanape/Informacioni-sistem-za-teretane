...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.55]{sections/images/dijagram_aktivnosti_za_online_registraciju_neregistrovanog_korisnika.jpg}
\end{center}
...
\subsubsection{Slučaj upotrebe: Online izbor vrste članarine za klijenta}
\subfile{sections/korisnik/izbor_vrste_clanarine_registrovanog_korisnika}

\subsubsection{Slučaj upotrebe: Uživo izbor vrste članarine za klijenta}
\subfile{sections/korisnik/izbor_vrste_clanarine_uzivo}
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.55]{sections/images/bpmn_dijagram_saradnje_izbor_vrste_clanarine_uzivo.jpg}
\end{center}
\caption{BPMN dijagram saradnje za izbor vrste članarine online}
\label{fig:kontekst}
\end{figure}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.55]{sections/images/dijagram_aktivnosti_usluge_igraonice_online.jpg}
\end{center}
