...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.35]{sections/images/bpmn_dijagram_procesa_prijava_za_licencu.png}
\end{center}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.35]{sections/images/bpmn_dijagram_saradnje_prijava_za_licencu.png}
\end{center}
