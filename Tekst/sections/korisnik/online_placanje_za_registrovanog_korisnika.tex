...
\hline
   Preduslovi & \begin{enumerate}
       ...
       % TODO: \item Klijent ima pristup internetu.
...
\hline
    Alternativni tokovi & \begin{enumerate}
        	...
        	\item [A3] Klijent nema dovoljno sredstava na računu: Klijentu se pruža prilika da unese broj (i ostale parametre) druge platne kartice (ukoliko takvu poseduje) i da sa njom pokuša plaćanje. Slučaj se nastavlja u koraku 2. % Klijent moze i da odustane kada se vrati na korak 2, zato to nije naglaseno ovde ponovo.
        	...
        	%\item [A6] Potvrda o izvršenoj uplati nije poslata klijentu: Klijent obaveštava sistem o tome, nakon čega sistem ponovo šalje potvrdu. Slučaj upotrebe se nastavlja u koraku 5.
            \end{enumerate}\\
\hline
    Podtokovi & / \\
\hline
